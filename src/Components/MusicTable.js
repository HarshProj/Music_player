      ...
      <tbody>
        {musicData.map((song, index) => (
          <tr
            ...
            >
            <td className=" h-full   flex justify-start"><div className={`${
              song.playing ?"w-1 h-full bg-[#CA0000]":""}`}></div></td>
            <td className="h-[7vh] px-4  text-center">{index + 1}</td>
            <td className="h-[7vh] px-4 flex items-center gap-4"><img src={song.image} alt="" className='w-[45px] h-[45px]'/>{song.title}</td>
